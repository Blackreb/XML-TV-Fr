...
Les fichiers de sorties XML sont mis à jour tous les jours vers 6h15 et sont stockés dans le dossier xmltv :
 - au format XML : [xmltv.xml](https://github.com/Blackreb/XML-TV-Fr/raw/master/xmltv/xmltv.xml)
 - au format GZ : [xmltv.xml.gz](https://github.com/Blackreb/XML-TV-Fr/raw/master/xmltv/xmltv.xml.gz)
 - au format ZIP : [xmltv.zip](https://github.com/Blackreb/XML-TV-Fr/raw/master/xmltv/xmltv.zip)
